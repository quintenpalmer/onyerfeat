...
COPY characters (id, name, ability_score_set_id, alignment_order, alignment_morality, player_name, class, deity) FROM stdin;
1	IDRIGOTH	1	neutral	good	Quinten	fighter	\N
\.
