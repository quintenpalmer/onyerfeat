        ...
        , Html.div [ Attr.class "row" ]
            [ Html.div [ Attr.class "col-md-5" ]
                ...
                , Html.div [ Attr.class "text-center" ]
                    ...
                    , Html.form [ Attr.class "form-inline" ]
                        [ Html.div [ Attr.class "form-group" ]
                            [ Html.label [] [ Html.text "Nonlethal Damage:" ]
                            , Html.input [ Attr.type_ "text", Attr.readonly True, Attr.class "form-control", Attr.value <| toString character.combatNumbers.nonlethalDamage ] []
                            ]
                        ]
                    ]
                ]
